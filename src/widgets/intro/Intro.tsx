export default function Intro() {
  return (
    <div className="w-full h-[800px] bg-[url('/assets/images/background.jpg')] bg-no-repeat bg-contain bg-center">
      <div className="flex flex-col gap-1 px-[5%] sm:px-[5%] xl:px-[10%] 2xl:px-[19%]">
